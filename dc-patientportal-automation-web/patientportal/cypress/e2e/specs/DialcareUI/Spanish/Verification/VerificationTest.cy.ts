context("VERIFICATION TEST CASE", () => {
  ...
  specify("verify user redirect to verification page", () => {
    cy.origin(redirectUrl, () => {
      // let uniquePart = Math.floor(Math.random() * 1000000);
      let uniqueEmail = `sherrie@mailinator.com`;
  ...
  specify("verify verification label in verification page", () => {
    cy.origin(redirectUrl, () => {
      // let uniquePart = Math.floor(Math.random() * 1000000);
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
  ...
  specify("verify verification text box should be visible ", () => {
    cy.origin(redirectUrl, () => {
      // let uniquePart = Math.floor(Math.random() * 1000000);
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
  ...
  specify("verify verification code button is visible", () => {
    cy.origin(redirectUrl, () => {
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
      let forgotEmailTxtBx = "input#email";
  ...
  specify("verify code not recevied text is visible", () => {
    cy.origin(redirectUrl, () => {
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
      let forgotEmailTxtBx = "input#email";
  ...
  specify("verify resend link is visible", () => {
    cy.origin(redirectUrl, () => {
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
      let forgotEmailTxtBx = "input#email";
  ...
  specify("verify continue button is visible", () => {
    cy.origin(redirectUrl, () => {
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
      let forgotEmailTxtBx = "input#email";
  ...
  specify("verify information is required error message", () => {
    cy.origin(redirectUrl, () => {
      let uniqueEmail = `sherrie@mailinator.com`;
      let forgotPasswordLnk = "a#forgotPassword";
      let forgotEmailTxtBx = "input#email";
