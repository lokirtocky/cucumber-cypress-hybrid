...
describe("Payments APIs", () => {
  ...
  it("Negative - Validate appointment for patientId invalid patient portal API POST", () => {
    const requestBody = {
      patientId: -352,
      patientFirstName: "Johnd",
      patientLastName: "Smith",
      groupCode: "GRPDCUCPA50",
      appointmentType: "OnDemand",
      consultType: "Audio",
      startDateTime: "2024-04-30T10:24:05",
      appointmentRequestmode: "Web",
      requestor: "Johnd",
      consultDemographicState: "CA",
      consultFee: 160,
  ...
  it("Negative - Validate appointment for patient First Name patient portal API POST", () => {
    const requestBody = {
      patientId: -352,
      patientFirstName: "",
      patientLastName: "Smith",
  ...
  it("Negative - Validate appointment for Start datetime must exceeds current time by more than 15 minutes patient portal API POST", () => {
    const requestBody = {
      patientId: 352,
      patientFirstName: "Johnd",
      patientLastName: "Smith",
