...
describe("Add Provider And Schedule for TH", () => {
    let providerId: any;
    it("Add Provider TH post Request", () => {
        ...
        const email = faker.person.firstName() + faker.person.lastName() + "001" + "TH@mailinator.com";
        const requestBody = {
    ...
    it("Get Schedule API  Details", () => {
        ...
        cy.task('log', startDateTime)
        cy.task('log', endDateTime)
        const requestBody = {
            "id": 0,
